...
interface ShortLinkManager {
   ...
   *
   * @param updater An optional user who is updating the short link. This will be used to determine
   *   whether the user has permission to update the short link.
   ...
   *
   * @param deleter An optional user who is deleting the short link. This will be used to determine
   *   whether the user has permission to delete the short link.
